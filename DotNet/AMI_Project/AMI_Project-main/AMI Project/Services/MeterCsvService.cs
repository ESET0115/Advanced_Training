...
namespace AMI_Project.Services
{
    public class MeterCsvService : IMeterCsvService
    {
        ...
        public MeterCsvService(IMeterRepository meterRepository)
        {
            _meterRepository = meterRepository;
        }

        public async Task<IEnumerable<Meter>> UploadAndImportAsync(MeterUploadResultDto dto, CancellationToken ct)
        {
        ...
        // Helper record class for CSV mapping
